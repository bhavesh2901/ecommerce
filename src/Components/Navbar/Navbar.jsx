...
import imagelogo from '../Assests/logo.webp';
            ...
            <nav className="navbar navbar-expand-custom navbar-mainbg">
                    ...
                    <ul className="navbar-nav ml-auto mx-5">
                        <li className='nav-item'>
                            <div className="hori-selector mx-3 d-flex">
                                ...
                                <div class="d-flex">
                                    <input class="form-control mr-sm-2 rounded-lg mx-2 mt-1" type="search" placeholder="Search" size="50" aria-label="Search"/>
                                    <button class="btn mt-1" type="submit"><i class="fa-solid fa-magnifying-glass"></i></button>
                                </div>

                            </div>
                        </li>
                        <li className={menus === "shop" ? "nav-item active" : "nav-item"}>
                            <Link to='/' className="nav-link" onClick={() => setMenus('shop')}><i className="fas fa-tachometer-alt"></i>Shop</Link>
                        </li>
                        <li className={menus === "mens" ? "nav-item active" : "nav-item"}>
                            <Link to='/mens' className="nav-link" onClick={() => setMenus('mens')}><i className="fa-solid fa-person"></i>Man</Link>
                        </li>
                        <li className={menus === "women" ? "nav-item active" : "nav-item"}>
                            <Link to='/womens' className="nav-link" onClick={() => setMenus('women')}><i className="fa-solid fa-person-dress"></i>Women</Link>
                        </li>
                        <li className={menus === "kids" ? "nav-item active" : "nav-item"}>
                            <Link to='/kids' className="nav-link" onClick={() => setMenus('kids')}><i className="fa-sharp fa-solid fa-baby"></i>kids</Link>
                        </li>
                    </ul>
                </div>
               {/* Show initials and full username if user exists, otherwise show login button */}
                    {user ? (
                        ...
                        <Link to='/LoginSignup' className="btn bg-black mx-2 text-white mt-2">
